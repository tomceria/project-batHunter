...
public class LevelManager : MonoBehaviour {
	...
	public static double gameTime = 0;			// Not actual game-time, as it stops when enemy count reach max
	public static int enemyMax = 25;
			...
			switch (stageID) {
				case 0: {			// TEST LEVEL
					switch (spawnQueue) {
						...
						case 2: {
							...
							spawnBatchCmd ("straightRight", "tameBat", 5, -4.5f, 3.5f, 0.5f, 0, batchMod);
							gameTimeMark = 12;
							break;
						}
						case 3: {
							batchMod[1]=1;		batchMod[2]=5f;		batchMod[3]=1f;
							spawnBatchCmd ("sinDown", "tameBat", 10, 1f, 5.5f, 0.5f, 0, batchMod);
							batchMod2[1]=1;		batchMod2[2]=5f;	batchMod2[3]=-1f;
							spawnBatchCmd ("sinDown", "tameBat", 10, 1f, 5.5f, 0.5f, 0, batchMod2);
							//
							gameTimeMark = 30;
							break;
						}
                        case 4: {
							...
							spawnBatchCmd ("curveRight", "heatemitBat", 20, -4.5f, -3.5f, 1f, 0, batchMod);
							gameTimeMark = 40;
							break;
						}
						case 5: {
							batchMod[1]=5f;	batchMod[2]=0.5f;	batchMod[3]=3;	batchMod[4]=0.5f;
							spawnBatchCmd ("autoZigzagPlayer", "heatemitBat", 1, -4.5f, 3.5f, 0, 0, batchMod);
							gameTimeMark = 45;
							break;
						}
						case 6: {
							batchMod[0]=4f;	batchMod[1]=1f;	batchMod[2]=2f;	batchMod[3]=1f;	batchMod[4]=5f;	batchMod[5]=5f;
							spawnBatchCmd ("linkedToY-autoRandomXY", "tameBat", 1, 1f, 5f, 0, 0, batchMod);
							gameTimeMark = 100;
							break;
						}
					}
				...
				case 1: {
					switch (spawnQueue) {
						...
						case 2: {
							batchMod[0]=4f;	batchMod[1]=1f;	batchMod[2]=2f;	batchMod[3]=1f;	batchMod[4]=5f;	batchMod[5]=5f;
							spawnBatchCmd ("linkedToY-autoRandomXY", "tameBat", 1, -1.5f, 5.5f, 0, 0, batchMod);
							batchMod2[0]=4f;	batchMod2[1]=1f;	batchMod2[2]=2f;	batchMod2[3]=1f;	batchMod2[4]=5f;	batchMod2[5]=5f;
							spawnBatchCmd ("linkedToY-autoRandomXY", "tameBat", 1, 0f, 5.5f, 0, 0, batchMod);
						...
						case 3: {
							...
							spawnBatchCmd ("curveRight", "random3Bat", 20, -4.5f, 5.5f, 0.5f, 0, batchMod);
							gameTimeMark = 16;
							break;
						}
						case 4: {
						...
						case 5: {
							...
							spawnBatchCmd ("autoZigzagPlayer", "tankyannoyingBat", 1, 0f, 5.5f, 0, 0, batchMod);
							gameTimeMark = 30;
							break;
						}
					}
	...
	void spawnBatchCmd (string batchID, string enemyID, int enemyQuantity, float posX, float posY, float spawnTimeGap, float spawnDelay, float[] mod) {
